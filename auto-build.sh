...
sudo wget https://github.com/chinaphp/sealer/releases/download/v0.11.12/sealer-v0.11.12-linux-amd64.tar.gz && tar -xvf sealer-v0.11.12-linux-amd64.tar.gz -C /usr/bin
